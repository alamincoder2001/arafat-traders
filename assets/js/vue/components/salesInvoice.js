            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        ...
                        <strong>Customer Designation:</strong> {{ sales.Customer_Designation }}<br>
                        <strong>Owner Name:</strong> {{ sales.customer_owner_name }}<br>
                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right">{{ sales.SaleMaster_LabourCost }}</td>
                            </tr>
                        ...
                        <div class"row" style="margin-top: 50px;>
                            <div class="col-xs-6 col-xs-offset-4">
                                <table>
                                    <tr>
                                        <th>বিঃ দ্রঃ</th>
                                        <th>মাল ডেলিভারীর সময় বুঝিয়া লইবেন।</th>
                                    </tr>
                                    <tr>
                                        <th></th>
                                        <th>বিক্রিত মাল ফেরত নেওয়া হয়না।</th>
                                    </tr>
                                </table>
                            </div>
                        </div>
