...
class Account extends CI_Controller {
    ...
    function getOtherIncomeExpense(){
        ...
        $customerDiscountDateClause = "";
        $supplierCommissionDateClause = "";
        $damageClause = "";
        $returnClause = "";
        if(isset($data->dateFrom) && $data->dateFrom != '' && isset($data->dateTo) && $data->dateTo != ''){
            ...
            $customerDiscountDateClause = " and cp.CPayment_date between '$data->dateFrom' and '$data->dateTo'";
            $supplierCommissionDateClause = " and sp.SPayment_date between '$data->dateFrom' and '$data->dateTo'";
        }
        ...
        $result = $this->db->query("
            ...
            (
                ...
                where sp.SPayment_brunchid = '" . $this->session->userdata('BRANCHid') . "'
                and sp.SPayment_status = 'a'
                and sp.SPayment_TransactionType = 'CD'
                $supplierCommissionDateClause
            ) as supplier_commission
