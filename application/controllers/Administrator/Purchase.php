...
class Purchase extends CI_Controller
{
    ...
    public function getPurchaseDetailsForReturn()
    {
        ...
        $purchaseDetails = $this->db->query("
            ...
            left join tbl_brunch b on b.brunch_id=pd.PurchaseDetails_branchID
        ...
        try {
            ...
            foreach ($data->cart as $product) {
                $returnDetails = array(
                    ...
                    'AddBy' => $this->session->userdata("FullName"),
                    'AddTime' => date('Y-m-d H:i:s'),
                    'PurchaseReturnDetails_brachid' => $product->brunch_id
                );
                ...
                $this->db->query("
                    ...
                    where product_id = ?
                    and branch_id = ?
                ", [$product->return_quantity, $product->Product_IDNo, $product->brunch_id]);
            }
    ...
    public function addPurchase()
    {
        ...
        try {
            ...
            $purchase = array(
                ...
                'PurchaseMaster_LabourCost' => $data->purchase->labour,
    ...
    public function  deletePurchase()
    {
        ...
        try {
            ...
            $purchaseDetails = $this->db->select('Product_IDNo,PurchaseDetails_TotalQuantity,PurchaseDetails_branchID')->where('PurchaseMaster_IDNo', $data->purchaseId)->get('tbl_purchasedetails')->result();
            ...
            foreach ($purchaseDetails as $detail) {
                ...
                $totalQty = $this->db->where(['product_id' => $detail->Product_IDNo, 'branch_id' => $detail->PurchaseDetails_branchID])->get('tbl_currentinventory')->row()->purchase_quantity;
                ...
                $this->db->set('purchase_quantity', $newQty)->where(['product_id' => $detail->Product_IDNo, 'branch_id' => $detail->PurchaseDetails_branchID])->update('tbl_currentinventory');
            }
