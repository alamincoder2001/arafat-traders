...
class Supplier extends CI_Controller {
    ...
    public function getSupplierDue(){
        ...
        $supplierDues = $this->mt->supplierDue($supplierClause);
    ...
    public function getSupplierLedger(){
        ...
        $payments = $this->db->query("
            ...
            select 
                ...
                0.00 as returned,
                0.00 as cash_received,
                sp2.SPayment_amount as discount,
                0.00 as balance
        ...
        foreach($payments as $key=>$payment){
            ...
            $payment->balance = ($lastBalance + $payment->bill + $payment->cash_received) - ($payment->paid + $payment->returned + $payment->discount);
        }
    ...
    public function getSupplierPayments(){
        ...
        if(isset($data->paymentType) && $data->paymentType != '' && $data->paymentType == 'discount'){
            $paymentTypeClause = " and sp.SPayment_TransactionType = 'CD'";
        }
