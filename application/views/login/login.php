					...
					<div class="form">
						...
						<form method="post" action="<?php echo base_url();?>Login/procedure">
							<div class="form-group">
								...
								<input type="text" name="user_name" class="form-control notranslate" placeholder="User Name">
							</div>
							<div class="form-group">
								<?php echo form_error('password'); ?>
								<input type="password" name="password" class="form-control notranslate" placeholder="Password">
							</div>
							<div class="form-group">
