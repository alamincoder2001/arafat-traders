	...
	<div class="row">
		<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
			<div class="form-group" style="margin-top:10px;">
				...
				<div class="col-sm-2">
					<v-select class="notranslate" v-bind:options="searchTypes" v-model="selectedSearchType" label="text" v-on:input="onChangeSearchType"></v-select>
				</div>
			</div>
	
			<div class="form-group" style="margin-top:10px;" v-if="selectedSearchType.value == 'category'">
				<div class="col-sm-2" style="margin-left:15px;">
					<v-select class="notranslate" v-bind:options="categories" v-model="selectedCategory" label="ProductCategory_Name"></v-select>
				</div>
			</div>
	
			<div class="form-group" style="margin-top:10px;" v-if="selectedSearchType.value == 'product'">
				<div class="col-sm-2" style="margin-left:15px;">
					<v-select class="notranslate" v-bind:options="products" v-model="selectedProduct" label="display_text"></v-select>
				</div>
			</div>

			<div class="form-group" style="margin-top:10px;" v-if="selectedSearchType.value=='branch'">
				<div class="col-sm-2" style="margin-left:15px;">
					<v-select class="notranslate" v-bind:options="branches" v-model="selectedBranch" label="Brunch_name"></v-select>
				</div>
				<div class="col-sm-2" style="margin-left:15px;">
					<v-select class="notranslate" v-bind:options="products" v-model="selectedProduct" label="display_text"></v-select>
				</div>
			...
			<div class="form-group" style="margin-top:10px;" v-if="selectedSearchType.value == 'brand'">
				<div class="col-sm-2" style="margin-left:15px;">
					<v-select class="notranslate" v-bind:options="brands" v-model="selectedBrand" label="brand_name"></v-select>
				</div>
			</div>
	...
	new Vue({
		...
		methods:{
			getStock(){
				...
				if(this.selectedSearchType.value == 'branch' && this.selectedBranch != null) {
					parameters = {
						branchId: this.selectedBranch.brunch_id,
						productId: this.selectedProduct != null ? this.selectedProduct.Product_SlNo : null
					}
					this.selectionText = "branch: " + this.selectedBranch.Brunch_name;
				}
			...
			onChangeSearchType(){
				if(this.selectedSearchType.value == 'category' && this.categories.length == 0){
					...
					this.getProducts();
				} else if (this.selectedSearchType.value == 'branch' && this.branches.length == 0 ) {
					this.getProducts();
					this.getBranch();
				}
			},
