        ...
        <div class="col-md-6">
            <form @submit.prevent="saveSettings">
                ...
                <div class="form-group clearfix">
                    ...
                    <div class="col-md-8">
                        <input type="text" class="form-control notranslate" v-model="settings.api_key" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">URL</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control notranslate" v-model="settings.url" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Bulk URL</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control notranslate" v-model="settings.bulk_url" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Sender Id</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control notranslate" v-model="settings.sender_id" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">SMS Type</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control notranslate" v-model="settings.sms_type" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Sender Name</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control notranslate" v-model="settings.sender_name" required>
                    </div>
                </div>
                <div class="form-group clearfix">
                    <label class="control-label col-md-4">Sender Phone</label>
                    <div class="col-md-8">
                        <input type="text" class="form-control notranslate" v-model="settings.sender_phone" required>
                    </div>
                </div>
                <div class="form-group clearfix">
