        ...
        <div class="form-horizontal">
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" name="txtFirstName" id="txtFirstName" value="<?php echo $selected->FullName; ?>" class="form-control notranslate" />
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="email" name="user_email" id="user_email" value="<?php echo $selected->UserEmail; ?>" class="form-control notranslate" />
                    </div>
                </div>
            ...
            <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="text" id="username" name="username" onchange="check_username()" value="<?php echo $selected->User_Name; ?>" class="form-control notranslate" readonly />
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="password" id="assword" name="Password" placeholder="Password" class="form-control notranslate" />
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <input type="password" id="rePassword" name="rePassword" placeholder="Re-Password" onchange="password()" class="form-control notranslate" />
