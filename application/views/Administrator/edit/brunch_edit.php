...
<div class="form-horizontal">
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" id="Brunchname" name="Brunchname" value="<?php echo $selected->Brunch_name; ?>" class="form-control notranslate" />
			<span id="msg"></span>
	...
	<div class="form-group">
		...
		<label class="col-sm-1 control-label no-padding-right">:</label>
		<div class="col-sm-3">
			<input type="text" id="brunchtitle" name="brunchtitle" value="<?php echo $selected->Brunch_address; ?>" class="form-control notranslate" />
			<span id="msg"></span>
			<span style="color:red;font-size:15px;">
		</div>
	</div>
	...
	<div class="form-group">
		...
		<label class="col-sm-1 control-label no-padding-right">:</label>
		<div class="col-sm-3">
			<textarea name="brunchaddress" id="brunchaddress" class="form-control notranslate"><?php echo $selected->Brunch_address; ?></textarea>
		</div>
	</div>
