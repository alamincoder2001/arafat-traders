<div class="form-horizontal">
	<div class="col-sm-6">
		<div class="form-group" style="">
			...
			<div class="col-sm-6">
				<input type="text" name="Transaction_id" id="Transaction_id" value="<?php echo $selected->Tr_Id; ?>" class="form-control notranslate" readonly />
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>	
			<div class="col-sm-6">
				<input class="form-control notranslate date-picker" name="DaTe" id="DaTe" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" value="<?php echo $selected->Tr_date; ?>" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="Description" name="Description" value="<?php echo $selected->Tr_Description; ?>" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group" style="display:none;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="ChequeNumber" name="ChequeNumber" value="<?php echo $selected->ChequeNumber; ?>" class="form-control notranslate" />
			</div>
		</div>
