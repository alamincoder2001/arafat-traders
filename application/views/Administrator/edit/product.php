...
<div class="col-xs-12">
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="Product_id" id="Product_id" value="<?php echo $selected->Product_Code; ?>" class="form-control notranslate" readonly />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="pro_Name" name="pro_Name" value="<?php echo htmlentities($selected->Product_Name); ?>" placeholder="Product name .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="vat" name="vat" value="<?php echo $selected->vat; ?>" placeholder="VAT" class="form-control notranslate" />
			</div>
		</div>
	...
	<div class="col-sm-6">
		<div class="form-group" id="reOrderDiv" style="display:<?php echo $selected->is_service == 'true' ? 'none' : '';?>;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="Re_Order" name="Re_Order" value="<?php echo $selected->Product_ReOrederLevel; ?>" placeholder="Re-order Level" class="form-control notranslate" />
		...
		<div class="form-group" style="display:;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="Purchase_rate" name="Purchase_rate" value="<?php echo $selected->Product_Purchase_Rate; ?>"  placeholder="Purchase Rate" class="form-control notranslate" />
		...
		<div class="form-group" style="display:;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="sell_rate" name="sell_rate" value="<?php echo $selected->Product_SellingPrice; ?>" class="form-control notranslate" />
		...
		<div class="form-group" style="display: none;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="minimum_sell_rate" name="minimum_sell_rate" value="<?php echo $selected->Product_MinimumSellingPrice; ?>"  placeholder="Permenent Hospital Name" class="form-control notranslate" />
			</div>
		</div>
		 ...
		 <label class="col-sm-4 control-label" for="wholesell_rate"> Wholesell Rate </label>
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="Wholesales" name="Wholesales" value="<?php echo $selected->Product_WholesaleRate; ?>"  placeholder="Whole sale rate" class="form-control notranslate" />
			</div>
		 </div> 
