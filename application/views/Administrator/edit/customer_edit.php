...
<div class="col-xs-12">
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="Customer_id" id="Customer_id" value="<?php echo $selected->Customer_Code; ?>" class="form-control notranslate" readonly />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="cus_name" name="cus_name" value="<?php echo $selected->Customer_Name; ?>" placeholder="Customer name .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="owner_name" name="owner_name" value="<?php echo $selected->owner_name; ?>" placeholder="Owner name .." class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="address" name="address" placeholder="Customer Address .." class="form-control notranslate" value="<?php echo $selected->Customer_Address; ?>" />
		...
		<div class="form-group" style="display: none;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="phone" name="phone" value="<?php echo $selected->Customer_Phone; ?>" placeholder="Enter phone Number" class="form-control notranslate" />
			</div>
		</div>
	</div>
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="mobile" name="mobile" value="<?php echo $selected->Customer_Mobile; ?>"  placeholder="Enter mobile" class="form-control notranslate" />
		...
		<div class="form-group"  style="display: none;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="email" name="email" value="<?php echo $selected->Customer_Email; ?>" placeholder="Enter E-mail" class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="office_phone" name="office_phone" value="<?php echo $selected->Customer_OfficePhone; ?>"  placeholder="Enter office phone" class="form-control notranslate" />
			</div>
		</div> 
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="previous_due" name="previous_due" value="<?php echo $selected->previous_due; ?>"  placeholder="Previous due" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="credit" name="credit" value="<?php echo $selected->Customer_Credit_Limit; ?>"  placeholder="Credit Limit" class="form-control notranslate" />
			</div>
		</div>
