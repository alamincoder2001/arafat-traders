	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="account_id" id="account_id"  value="<?php echo $selected->Acc_Code; ?>" class="form-control notranslate" readonly />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="accountName" name="accountName" value="<?php echo $selected->Acc_Name; ?>" placeholder="Account name .." class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group" style="display:none;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input name="accounttype" type="text" id="accounttype" value="<?php echo $selected->Acc_Type; ?>" class="form-control notranslate" readonly />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="Description" name="Description" value="<?php echo $selected->Acc_Description; ?>" class="form-control notranslate" />
			</div>
		</div>
