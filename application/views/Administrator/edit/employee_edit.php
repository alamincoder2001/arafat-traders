...
<div class="row">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="Employeer_id" id="Employeer_id" name="Employeer_id" value="<?php echo $selected->Employee_ID; ?>" class="form-control notranslate" readonly />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_name" name="em_name" value="<?php echo $selected->Employee_Name; ?>" placeholder="Employee Name .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>	
				<div class="col-sm-6">
				<input class="form-control notranslate date-picker" name="em_Joint_date" id="em_Joint_date" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" value="<?php echo $selected->Employee_JoinDate; ?>" />
				</div>
			</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="salary_range" name="salary_range" value="<?php echo $selected->salary_range; ?>" placeholder="Salary Range .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_Present_address" name="em_Present_address" value="<?php echo $selected->Employee_PrasentAddress; ?>" placeholder="Present Address" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_Permanent_address" name="em_Permanent_address" value="<?php echo $selected->Employee_PermanentAddress; ?>" placeholder="Present Address" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_contact" name="em_contact"  value="<?php echo $selected->Employee_ContactNo; ?>" placeholder="Purchase Rate" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="ec_email" name="ec_email" value="<?php echo $selected->Employee_Email; ?>" placeholder="E-mail" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="file" id="em_photo" name="em_photo" class="form-control notranslate" onchange="readURL(this)" style="height:35px" />
			</div>
		</div>
	...
	<div class="form-horizontal">
		...
		<hr/>
			<div class="form-group">
				...
				<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
					<input type="text" id="em_father" name="em_father" value="<?php echo $selected->Employee_FatherName; ?>" placeholder="Father's Name" class="form-control notranslate" />
				</div>
			</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="mother_name" name="mother_name" value="<?php echo $selected->Employee_MotherName; ?>" placeholder="Mother's Name" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>	
				<div class="col-sm-6">
				<input class="form-control notranslate date-picker" name="em_dob" id="em_dob" value="<?php echo $selected->Employee_BirthDate; ?>" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" />
				</div>
			</div>
