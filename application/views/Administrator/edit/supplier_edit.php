...
<div class="col-xs-12">
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="supplier_id" id="supplier_id" value="<?php echo $selected->Supplier_Code; ?>" class="form-control notranslate" readonly />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="sl_name" name="sl_name" value="<?php echo $selected->Supplier_Name; ?>" placeholder="Supplier name .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="contact_person" name="contact_person" value="<?php echo $selected->contact_person; ?>" placeholder="Contact Person ..." class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<textarea id="address" name="address" placeholder="Supplier Address .." class="form-control notranslate" ><?php echo $selected->Supplier_Address; ?></textarea>
			</div>
		</div>
		...
		<div class="form-group" style="display:none;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="phone" name="phone" value="<?php echo $selected->Supplier_Phone; ?>" placeholder="Enter phone Number" class="form-control notranslate" />
			</div>
		</div>
	</div>
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="mobile" name="mobile" value="<?php echo $selected->Supplier_Mobile; ?>"  placeholder="Enter mobile" class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="email" name="email" value="<?php echo $selected->Supplier_Email; ?>" placeholder="Enter E-mail" class="form-control notranslate" />
		...
		<div class="form-group" style="display:none;">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="office_phone" name="office_phone" value="<?php echo $selected->Supplier_OfficePhone; ?>"  placeholder="Enter office phone" class="form-control notranslate" />
			</div>
		</div> 
