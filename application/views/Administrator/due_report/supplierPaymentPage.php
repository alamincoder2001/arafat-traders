				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						<div class="form-group">
							...
							<div class="col-md-7">
								<select class="form-control notranslate" v-model="payment.SPayment_TransactionType" required>
									<option value=""></option>
									<option value="CD">Commision</option>
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<select class="form-control notranslate" v-model="payment.SPayment_Paymentby" required>
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-6">
								<select class="form-control notranslate" v-if="suppliers.length == 0"></select>
								<v-select class="notranslate" v-bind:options="suppliers" v-model="selectedSupplier" label="display_name" @input="getSupplierDue" v-if="suppliers.length > 0"></v-select>
							</div>
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control notranslate" v-model="supplierDue">
							</div>
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="date" class="form-control notranslate" v-model="payment.SPayment_date" required @change="getSupplierPayments" v-bind:disabled="userType == 'u' ? true : false">
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control notranslate" v-model="payment.SPayment_notes">
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" class="form-control notranslate" v-model="payment.SPayment_amount" required>
							</div>
						</div>
						<div class="form-group">
