...
$totalDue = $type == 'CR' || $type == 'CD' ? $prevdueAmont - $CPROW->CPayment_amount : $prevdueAmont + $CPROW->CPayment_amount;
            ...
            <div class="col-xs-12">
                <table class="border" cellspacing="0" cellpadding="0" style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <td style="text-align:right;"><?php if($type == 'CD'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></td>
                        </tr>
                        <tr>
                            ...
                            <th style="font-size: 13px; font-weight: 700;text-align:right;"><?php if($type == 'CD'): echo number_format($CPROW->CPayment_amount, 2); else: echo '00.00'; endif; ?></th>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-12 text-left;">
                <table style="width: 25%;float:left;">
                    ...
                    <tr>
                        <td  style="font-size: 13px; font-weight: 600; border-bottom: 2px solid #000; "><?php echo($type == 'CD' ? 'Discount Amount' : 'Paid Amount'); ?> : </td>
