				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						<div class="form-group">
							...
							<div class="col-md-7">
								<select class="form-control notranslate" v-model="payment.CPayment_TransactionType" required>
									<option value=""></option>
									<option value="CD">Discount</option>
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<select class="form-control notranslate" v-model="payment.CPayment_Paymentby" required>
						...
						<div class="form-group" style="display:none;" v-bind:style="{display: payment.CPayment_Paymentby == 'bank' ? '' : 'none'}">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<v-select class="notranslate" v-bind:options="filteredAccounts" v-model="selectedAccount" label="display_text" placeholder="Select account"></v-select>
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-6">
								<select class="form-control notranslate" v-if="customers.length == 0"></select>
								<v-select class="notranslate" v-bind:options="customers" v-model="selectedCustomer" label="display_name" @input="getCustomerDue" v-if="customers.length > 0"></v-select>
							</div>
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control notranslate" v-model="payment.CPayment_previous_due">
							</div>
						</div>
					</div>
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="date" class="form-control notranslate" v-model="payment.CPayment_date" required @change="getCustomerPayments" v-bind:disabled="userType == 'u' ? true : false">
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control notranslate" v-model="payment.CPayment_notes">
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" class="form-control notranslate" v-model="payment.CPayment_amount" required>
							</div>
						</div>
						<div class="form-group">
