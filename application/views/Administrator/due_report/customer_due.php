...
<div class="row" id="customerDueList">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group">
			...
			<div class="col-sm-2">
				<select class="form-control notranslate" v-model="searchType" v-on:change="onChangeSearchType" style="padding:0px;">
		...
		<div class="form-group" style="display: none" v-bind:style="{display: searchType == 'area' ? '' : 'none'}">
			...
			<div class="col-sm-2">
				<v-select class="notranslate" v-bind:options="areas" v-model="selectedArea" label="District_Name" placeholder="Select area"></v-select>
			</div>
		</div>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr v-for="data in dues">
						...
						<td>{{ data.Customer_Designation }}</td>
