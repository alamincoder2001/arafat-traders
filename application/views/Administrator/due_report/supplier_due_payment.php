...
<div class="col-sm-12" style="width:500px;">
	...
	<div class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input class="form-control notranslate date-picker" id="paymentDate" name="paymentDate" type="text" value="<?php echo date('Y-m-d'); ?>" name="pdate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;padding: 4px 6px 4px !important;width: 210px;float:left;" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="invoice" name="invoice" value="<?php if(isset($inv))echo $inv; ?>" class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="SuppID__" name="SuppID__" value="<?php if(isset($Cid))echo $Cid; ?>" class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="catname" name="catname" value="<?php if(isset($CName))echo $CName; ?>" class="form-control notranslate" readonly />
				<span id="msg"></span>
				<span style="color:red;font-size:15px;">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="totaldue" name="totaldue" value="<?php if(isset($due)) echo $due;?>" class="form-control notranslate" readonly />
				<span id="msg"></span>
				<span style="color:red;font-size:15px;">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="paidAmount" onkeyup="remainddue()" selected class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="remainddue" placeholder="Remainded Due" readonly class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<textarea id="Note" class="form-control notranslate"></textarea>
			</div>
		</div>
