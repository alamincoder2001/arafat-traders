...
<div class="col-xs-12">
	...
	<div class="col-sm-4 col-sm-offset-1">
		...
		<div class="form-group">
			...
			<div >
				<input name="companyLogo" id="companyLogo" type="file"  onchange="readURL(this)" class="form-control notranslate" style="height:35px;" />
			</div>
		</div>
	...
	<div class="col-sm-5 col-sm-offset-1">
		<div class="form-group">
			...
			<div class="col-sm-12">
				<input name="Company_name" type="text" id="Company_name" value="<?php echo $selected->Company_Name; ?>" class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<div class="col-sm-12">
				<textarea id="Description" name="Description" class="form-control notranslate"><?php echo $selected->Repot_Heading; ?></textarea>
			</div>
		</div>
	...
	<div class="col-sm-4 col-sm-offset-1">
		...
		<!-- <div class="form-group"> -->
			...
			<!-- <div class="col-sm-12"> -->
				<input name="companyLogo" required id="companyLogo" type="file" class="form-control notranslate" style="height:35px;" />
			<!-- </div> -->
		<!-- </div> -->
	...
	<div class="col-sm-5 col-sm-offset-1">
		<div class="form-group">
			<label class="col-sm-12 control-label" for="form-field-1"> Company Name </label>
			<div class="col-sm-12">
				<input name="Company_name" type="text" id="Company_name" value="" class="form-control notranslate" />
		...
		<div class="form-group">
			<label class="col-sm-12 control-label" for="form-field-1"> Description  </label>
			<div class="col-sm-12">
				<textarea id="Description" name="Description" class="form-control notranslate"></textarea>
			</div>
		</div>
