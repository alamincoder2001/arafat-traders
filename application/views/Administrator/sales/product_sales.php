	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			<div class="form-group">
				<label class="col-sm-1 col-xs-3 control-label no-padding-right"> Invoice no </label>
				<div class="col-sm-2 col-xs-9">
					<input type="text" id="invoiceNo" class="form-control notranslate" v-model="sales.invoiceNo" readonly />
				</div>
			</div>

			<div class="form-group">
				<label class="col-sm-1 col-xs-3 control-label no-padding-right"> Sales By </label>
				<div class="col-sm-2 col-xs-9">
					<v-select class="notranslate" v-bind:options="employees" v-model="selectedEmployee" label="Employee_Name" placeholder="Select Employee"></v-select>
				</div>
			</div>
			...
			<!-- <div class="form-group">
				...
				<div class="col-sm-2">
					<v-select class="notranslate" id="branchDropdown" v-bind:options="branches" label="Brunch_name" v-model="selectedBranch" disabled></v-select>
				</div>
			</div> -->

			<div class="form-group">
				<div class="col-sm-3">
					<input class="form-control notranslate" id="salesDate" type="date" v-model="sales.salesDate" v-bind:disabled="userType == 'u' ? true : false"/>
				</div>
			</div>
		</div>
	</div>
						...
						<div class="col-sm-5">
							...
							<div class="form-group">
								...
								<div class="col-sm-7 col-xs-11">
									<v-select class="notranslate" v-bind:options="customers" label="display_name" v-model="selectedCustomer" v-on:input="customerOnChange"></v-select>
								</div>
							...
							<div class="form-group" style="display:none;" v-bind:style="{display: selectedCustomer.Customer_Type == 'G' ? '' : 'none'}">
								...
								<div class="col-sm-8">
									<input type="text" id="customerName" placeholder="Customer Name" class="form-control notranslate" v-model="selectedCustomer.Customer_Name" v-bind:disabled="selectedCustomer.Customer_Type == 'G' ? false : true" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> Designation </label>
								<div class="col-sm-8">
									<input type="text" id="customerDesignation" placeholder="Designation" class="form-control notranslate" v-model="selectedCustomer.Customer_Designation" v-bind:disabled="selectedCustomer.Customer_Type == 'G' ? false : true" />
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label no-padding-right"> Mobile No </label>
								<div class="col-sm-8">
									<input type="text" id="mobileNo" placeholder="Mobile No" class="form-control notranslate" v-model="selectedCustomer.Customer_Mobile" v-bind:disabled="selectedCustomer.Customer_Type == 'G' ? false : true" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea id="address" placeholder="Address" class="form-control notranslate" v-model="selectedCustomer.Customer_Address" v-bind:disabled="selectedCustomer.Customer_Type == 'G' ? false : true"></textarea>
								</div>
							</div>
						</div>
							...
							<form v-on:submit.prevent="addToCart">
								<div class="form-group">
									...
									<div class="col-sm-8 col-xs-11">
										<v-select v-bind:options="branches" v-model="selectedBranch" label="Brunch_name" v-on:input="onChangeBranch"></v-select>
									</div>
									<div class="col-sm-1 col-xs-1" style="padding: 0;">
										<a href="<?= base_url('brunch') ?>" title="Add New Warehouse" class="btn btn-xs btn-danger" style="height: 25px; border: 0; width: 27px; margin-left: -10px;" target="_blank"><i class="fa fa-plus" aria-hidden="true" style="margin-top: 5px;"></i></a>
									</div>
                                </div> 
								...
								<div class="form-group">
									...
									<div class="col-sm-8 col-xs-11">
										<v-select class="notranslate" v-bind:options="products" v-model="selectedProduct" label="display_text" v-on:input="productOnChange"></v-select>
									</div>
									<div class="col-sm-1 col-xs-1" style="padding: 0;">
								...
								<div class="form-group" style="display: none;">
									...
									<div class="col-sm-9">
										<input type="text" id="brand" placeholder="Group" class="form-control notranslate" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" id="salesRate" placeholder="Rate" min="0" step="0.01" class="form-control notranslate" v-model="selectedProduct.Product_SellingPrice" v-on:input="productTotal"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> Quantity </label>
									<div class="col-sm-9">
										<input type="number" min="0" step="0.01" id="quantity" placeholder="Qty" class="form-control notranslate" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" required/>
									</div>
								</div>
								...
								<div class="form-group" style="display:none;">
									...
									<div class="col-sm-9">
										<span>(%)</span>
										<input type="text" id="productDiscount" placeholder="Discount" class="form-control notranslate" style="display: inline-block; width: 90%" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> Amount </label>
									<div class="col-sm-9">
										<input type="text" id="productTotal" placeholder="Amount" class="form-control notranslate" v-model="selectedProduct.total" readonly />
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr class="">
							...
							<th style="width:15%;color:#000;">Warehouse</th>
							...
							<div class="table-responsive">
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right">Sub Total</label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="subTotal" class="form-control notranslate" v-model="sales.subTotal" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right"> Vat </label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="vat" readonly="" class="form-control notranslate" v-model="sales.vat"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5  control-label no-padding-right">Dis. Persent</label>

												<div class="col-sm-4 col-xs-3">
													<input type="number" id="discountPercent" class="form-control notranslate" v-model="discountPercent" v-on:input="calculateTotal"/>
												</div>

												<label class="col-sm-1 col-xs-1 control-label no-padding-right">%</label>

												<div class="col-sm-7 col-xs-3">
													<input type="number" id="discount" class="form-control notranslate" v-model="sales.discount" v-on:input="calculateTotal"/>
												</div>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right">Transport Cost</label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" class="form-control notranslate" v-model="sales.transportCost" v-on:input="calculateTotal"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right">Labour Cost</label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" class="form-control notranslate" v-model="sales.labourCost" v-on:input="calculateTotal"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr style="display:none;">
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right">Round Of</label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="roundOf" class="form-control notranslate" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right">Total</label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="total" class="form-control notranslate" v-model="sales.total" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right">Paid</label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="paid" class="form-control notranslate" v-model="sales.paid" v-on:input="calculateTotal" v-bind:disabled="selectedCustomer.Customer_Type == 'G' ? true : false"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-2 control-label">Due</label>
												<div class="col-sm-6 col-xs-5">
													<input type="number" id="due" class="form-control notranslate" v-model="sales.due" readonly/>
												</div>
												<div class="col-sm-6 col-xs-5">
													<input type="number" id="previousDue" class="form-control notranslate" v-model="sales.previousDue" readonly style="color:red;"  />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<div class="col-sm-6 sales-btn">
													<input type="button" class="btn btn-default btn-sm custom-btn" value="Sale" v-on:click="saveSales" v-bind:disabled="saleOnProgress ? true : false" style="color: black!important;margin-top: 0px;width:100%;padding:5px;font-weight:bold;">
												</div>
												<div class="col-sm-6">
													<a class="btn btn-info btn-sm custom-btn" v-bind:href="`/sales/${sales.isService == 'true' ? 'service' : 'product'}`" style="color: black!important;margin-top: 0px;width:100%;padding:5px;font-weight:bold;">New Sale</a>
												</div>
											</div>
										</td>
									</tr>
		...
		methods:{
			...
			async productOnChange(){
				if((this.selectedProduct.Product_SlNo != '' || this.selectedProduct.Product_SlNo != 0) && this.sales.isService == 'false'){
					this.productStock = await axios.post('/get_product_stock', {productId: this.selectedProduct.Product_SlNo, branchId:this.selectedBranch.brunch_id}).then(res => {
			...
			addToCart(){
				let product = {
					...
					branchName:this.selectedBranch.Brunch_name
				}
				...
				if(parseFloat(product.quantity) > parseFloat(this.productStock)){
			...
			calculateTotal(){
				...
				this.sales.total = ((parseFloat(this.sales.subTotal) + parseFloat(this.sales.vat) + parseFloat(this.sales.transportCost) + parseFloat(this.sales.labourCost)) - parseFloat(this.sales.discount)).toFixed(2);
