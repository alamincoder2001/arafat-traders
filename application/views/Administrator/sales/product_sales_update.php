    ...
    <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" id="salesInvoiceno" name="salesInvoiceno"
                           value="<?php echo $sm_cus->SaleMaster_InvoiceNo; ?>" class="form-control notranslate" readonly/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" id="salesby" name="salesby"
                           value="<?php echo $this->session->userdata("FullName"); ?>" class="form-control notranslate" readonly/>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <input class="form-control notranslate date-picker" id="sales_date" name="sales_date" type="text"
...
<!--                                    </select>-->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="CusName" name="CusName" placeholder="Customer Name"
                                   value="<?php echo $sm_cus->Customer_Name; ?>" class="form-control notranslate" readonly/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" id="CusMobile" name="CusMobile" placeholder="Mobile No"
                                   value="<?php echo $sm_cus->Customer_Mobile; ?>" class="form-control notranslate" readonly/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea id="CusAddress" name="CusAddress" placeholder="Address" class="form-control notranslate"
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="proBrand" name="proBrand" placeholder="Group" class="form-control notranslate"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="saleIn" name="saleIn" placeholder="Sale In" class="form-control notranslate"/>
                        </div>
                        <label class="col-sm-3 control-label no-padding-right" for="PurchaseQTY"> Body Price </label>
                        <div class="col-sm-3">
                            <input type="number" id="bodyRate" name="bodyRate" placeholder="Rate" class="form-control notranslate"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="ProductRATE" name="ProductRATE" placeholder="Amount"
                                   class="form-control notranslate" readonly/>
                        </div>
                    </div>
                    </span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" id="SellsFreight" onkeyup="Freightonkeyup()"
                                                           name="SellsFreight" value="0" class="form-control notranslate"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <input type="number" id="SellsDiscount" onkeyup="Discountonkeyup2()"
                                                           name="SellsDiscount" value="0" class="form-control notranslate"/>
                                                </div>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    } ?>" onkeyup="PaidAmount()" class="form-control notranslate"/>
                                                    <label
                                                    ...
                                                    <input
                                                           ...
                                                           value="<?php if ($sm_cus) {echo $sm_cus->SaleMaster_PaidAmount;} ?>"
                                                            readonly class="form-control notranslate"
                                                    />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-12">
                                                    <input type="number" id="previousDue" name="previousDue"
                                                           value="<?php echo $dueAmont-$sm_cus->SaleMaster_DueAmount; ?>" class="form-control notranslate"
