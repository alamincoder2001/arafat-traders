	...
	<div class="form-group" style="margin-top:10px;">
		...
		<div class="col-sm-2">
			<div class="input-group">
				<input class="form-control notranslate date-picker" id="Sales_startdate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;" value="<?php echo date("Y-m-d") ?>" />
		...
		<div class="col-sm-2">
			<div class="input-group">
				<input class="form-control notranslate date-picker" id="Sales_enddate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;" value="<?php echo date("Y-m-d") ?>" />
				<span class="input-group-addon"style="border-radius: 0px 4px 4px 0px !important;padding: 4px 6px 4px  !important;">
					<i class="fa fa-calendar bigger-110"></i>
				</span>
			</div>
...
<script type="text/javascript">
    function Customerdata(){
        ...
        var urldata = "<?php echo base_url();?>customerSalesSearch";
