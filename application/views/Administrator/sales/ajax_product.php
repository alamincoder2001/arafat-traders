...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="proName" value="<?php echo $product->Product_Name; ?>" name="proName" class="form-control notranslate" />
	</div>
</div>
...
<div class="form-group" style="display:none;">
	...
	<div class="col-sm-9">
		<input type="text" id="proBrand" name="proBrand" value="<?php $product->brand_name; ?>" class="form-control notranslate" />
	</div>
</div>
...
<div class="form-group">
	...
	<div class="col-sm-3">
		<input type="number" id="proQTY" name="proQTY" onkeyup="discount_amount()" autofocus placeholder="Qty" class="form-control notranslate" />
	</div>
	<label class="col-sm-3 control-label no-padding-right" for="ProRATe"> Sales Rate </label>
	<!-- onkeyup="SaleInAmount2()" -->
	<div class="col-sm-3">
		<input type="text" id="salePrice" name="salePrice" onkeyup="discount_amount()"  value="<?php echo $product->Product_SellingPrice;?>"  placeholder="Rate" class="form-control notranslate" />
	</div>
</div>
...
<div class="form-group" style="display:none;">
	...
	<div class="col-sm-9">
		<span>(%)</span>
		<input type="text" id="pro_discount" name="pro_discount" onkeyup="discount_amount()"  placeholder="Discount" class="form-control notranslate"  style="display: inline-block; width: 90%" />
...
<div class="form-group">
	...
	<div class="col-sm-9">
		<input type="text" id="ProductAmont" name="ProductAmont" class="form-control notranslate" readonly />
	</div>
</div>