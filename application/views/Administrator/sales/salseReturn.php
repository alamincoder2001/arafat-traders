	...
	<div class="col-md-12" style="border-bottom: 1px solid #ccc;padding: 3px 0;">
		<form class="form-inline" id="searchForm">
			<div class="form-group" style="display:none;" v-bind:style="{display: customers.length > 0 ? '' : 'none'}">
				...
				<v-select class="notranslate" v-bind:options="customers" label="display_name" v-model="selectedCustomer" v-on:input="getInvoices" v-bind:disabled="salesReturn.returnId == 0 ? false : true"></v-select>
			</div>

			<div class="form-group">
				<label>Invoice</label>
				<v-select class="notranslate" v-bind:options="invoices" label="SaleMaster_InvoiceNo" v-model="selectedInvoice" v-bind:disabled="salesReturn.returnId == 0 ? false : true"></v-select>
			</div>
			<div class="form-group">
