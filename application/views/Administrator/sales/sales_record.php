		...
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				<div class="form-group">
					...
					<select class="form-control notranslate" v-model="searchType" @change="onChangeSearchType">
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'customer' && customers.length > 0 ? '' : 'none'}">
					...
					<v-select class="notranslate" v-bind:options="customers" v-model="selectedCustomer" label="display_name"></v-select>
				</div>

				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'employee' && employees.length > 0 ? '' : 'none'}">
					<label>Employee</label>
					<v-select class="notranslate" v-bind:options="employees" v-model="selectedEmployee" label="Employee_Name"></v-select>
				</div>

				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'quantity' && products.length > 0 ? '' : 'none'}">
					<label>Product</label>
					<v-select class="notranslate" v-bind:options="products" v-model="selectedProduct" label="display_text" @input="sales = []"></v-select>
				</div>
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'user' && users.length > 0 ? '' : 'none'}">
					<label>User</label>
					<v-select class="notranslate" v-bind:options="users" v-model="selectedUser" label="FullName"></v-select>
				</div>

				<div class="form-group" v-bind:style="{display: searchTypesForRecord.includes(searchType) ? '' : 'none'}">
					<label>Record Type</label>
					<select class="form-control notranslate" v-model="recordType" @change="sales = []">
					...
					<div class="form-group from">
						<input type="date" class="form-control notranslate" v-model="dateFrom">
					</div>

					<div class="form-group to">
						<input type="date" class="form-control notranslate" v-model="dateTo">
					</div>
					...
					<tbody>
						<template v-for="sale in sales">
							<tr>
								...
								<td>{{ sale.Customer_Designation }}</td>
