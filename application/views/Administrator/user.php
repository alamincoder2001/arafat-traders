...
<div class="col-xs-12">
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="txtFirstName" id="txtFirstName" placeholder="Full Name" value="" class="form-control notranslate" />
			</div>
		</div>
	...
	<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="email" name="user_email" id="user_email" onchange="check_email()" placeholder="User Email" class="form-control notranslate" />
			</div>
		</div>
	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="username" name="username" onchange="check_username()" placeholder="User name" class="form-control notranslate" />
