...
<div class="col-xs-12">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input type="text" id="catname" name="catname" placeholder="Category Name" value="<?php echo set_value('catname'); ?>" class="form-control notranslate" />
				<span id="msg"></span>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label no-padding-right">:</label>
			<div class="col-sm-3">
				<textarea name="catdescrip" id="catdescrip" class="form-control notranslate" placeholder="Category Description" ></textarea>
			</div>
		</div>
