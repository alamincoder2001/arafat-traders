		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="customer.Customer_Code" required readonly>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="customer.Customer_Name" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="customer.Customer_Designation" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="customer.owner_name">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="customer.Customer_Address">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control notranslate" v-if="districts.length == 0"></select>
						<v-select class="notranslate" v-bind:options="districts" v-model="selectedDistrict" label="District_Name" v-if="districts.length > 0"></v-select>
					</div>
			...
			<div class="col-md-5">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="customer.Customer_Mobile" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="customer.Customer_OfficePhone">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="number" class="form-control notranslate" v-model="customer.previous_due" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="number" class="form-control notranslate" v-model="customer.Customer_Credit_Limit" required>
					</div>
				</div>
					...
					<datatable :columns="columns" :data="customers" :filter-by="filter" style="margin-bottom: 5px;">
						<template scope="{ row }">
							<tr>
								...
								<td>{{ row.Customer_Designation }}</td>
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Designation', field: 'Customer_Designation', align: 'center' },
