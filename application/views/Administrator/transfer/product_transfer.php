                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="date" class="form-control notranslate" v-model="transfer.transfer_date">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4">Transfer by</label>
                                    <div class="col-md-8">
                                        <select class="form-control notranslate" v-bind:style="{display: employees.length > 0 ? 'none' : ''}"></select>
                                        <v-select class="notranslate" v-bind:options="employees" v-model="selectedEmployee" label="Employee_Name" v-bind:style="{display: employees.length > 0 ? '' : 'none'}"></v-select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4">Transfer to</label>
                                    <div class="col-md-8">
                                        <select class="form-control notranslate" v-bind:style="{display: branches.length > 0 ? 'none' : ''}"></select>
                                        <v-select class="notranslate" v-bind:options="branches" v-model="selectedBranch" label="Brunch_name" v-bind:style="{display: branches.length > 0 ? '' : 'none'}"></v-select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-5">
                                <div class="form-group">
                                    <textarea class="form-control notranslate" style="min-height:84px" placeholder="Note" v-model="transfer.note"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-9">
                                <form v-on:submit.prevent="addToCart()">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control notranslate" v-bind:style="{display: products.length > 0 ? 'none' : ''}"></select>
                                            <v-select class="notranslate" id="product" v-bind:options="products" v-model="selectedProduct" label="Product_Name" v-on:input="onChangeProduct" v-bind:style="{display: products.length > 0 ? '' : 'none'}"></v-select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Quantity</label>
                                        <div class="col-md-8">
                                            <input type="number" class="form-control notranslate" v-model="quantity" ref="quantity" required v-on:input="productTotal">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Amount</label>
                                        <div class="col-md-8">
                                            <input type="number" class="form-control notranslate" v-model="total" ref="total" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group">
