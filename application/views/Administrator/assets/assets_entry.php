	...
	<div class="form-horizontal">
		...
		<form method="POST" id="assetsForm" action="#">
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" id="assetsname" required name="assetsname" placeholder="Assets Name" class="form-control notranslate" />
					<span id="error"></span>
				</div>
			</div>
			<div class="form-group">
				...
				<label class="col-sm-1 control-label no-padding-right">:</label>
				<div class="col-sm-3">
					<input type="number" id="rate" required name="rate" placeholder="Rate" class="form-control notranslate" />
					<span id="error"></span>
				</div>
			</div>
			<div class="form-group">
				...
				<label class="col-sm-1 control-label no-padding-right">:</label>
				<div class="col-sm-3">
					<input type="number" id="qty" required name="qty" placeholder="Quantity" onblur="TotalAmount()" class="form-control notranslate" />
					<span id="error"></span>
				</div>
			</div>
			<div class="form-group">
				...
				<label class="col-sm-1 control-label no-padding-right">:</label>
				<div class="col-sm-3">
					<input type="number" id="amount" readonly name="amount" placeholder="Amount" class="form-control notranslate" />
				</div>
			</div>
			<div class="form-group">
