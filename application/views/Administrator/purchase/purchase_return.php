...
<div class="row" id="purchaseReturn">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;">
		<div class="form-group" style="margin-top:10px;">
			...
			<div class="col-sm-3">
				<v-select class="notranslate" v-bind:options="invoices" label="invoice_text" v-model="selectedInvoice" v-bind:disabled="purchaseReturn.returnId == 0 ? false : true"></v-select>
			</div>
			<div class="col-sm-2">
			...
			async productReturnTotal(ind) {
				if (this.checkStock) {
					let stock = await axios.post('/get_product_stock', {
							...
							branchId: this.cart[ind].brunch_id
						})
						.then(res => {
							return res.data;
						})
