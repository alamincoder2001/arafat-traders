	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			<div class="form-group">
				<label class="col-sm-1 col-xs-4  control-label no-padding-right"> Invoice no </label>
				<div class="col-sm-2 col-xs-8">
					<input class="input-field" type="text" id="invoice" name="invoice" v-model="purchase.invoice" readonly style="height:26px;" />
				</div>
			</div>
			...
			<!-- <div class="form-group">
				...
				<div class="col-sm-3">
					<v-select class="notranslate" id="branchDropdown" v-bind:options="branches" v-model="selectedBranch" label="Brunch_name" disabled></v-select>
				</div>
			</div> -->

			<div class="form-group">
				<label class="col-sm-1 col-xs-4 control-label no-padding-right"> Date </label>
				<div class="col-sm-3 col-xs-8 col-xs-8">
					<input class="form-control notranslate custom-input-field" id="purchaseDate" name="purchaseDate" type="date" v-model="purchase.purchaseDate" v-bind:disabled="userType == 'u' ? true : false" />
				</div>
			</div>
		</div>
	</div>
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="col-sm-7 col-xs-11">
									<v-select class="notranslate" v-bind:options="suppliers" v-model="selectedSupplier" v-on:input="onChangeSupplier" label="display_name"></v-select>
								</div>
							...
							<div class="form-group" style="display:none;" v-bind:style="{display: selectedSupplier.Supplier_Type == 'G' ? '' : 'none'}">
								...
								<div class="col-sm-8">
									<input type="text" placeholder="Supplier Name" class="form-control notranslate" v-model="selectedSupplier.Supplier_Name" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" placeholder="Mobile No" class="form-control notranslate" v-model="selectedSupplier.Supplier_Mobile" v-bind:disabled="selectedSupplier.Supplier_Type == 'G' ? false : true" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea class="form-control notranslate" v-model="selectedSupplier.Supplier_Address" v-bind:disabled="selectedSupplier.Supplier_Type == 'G' ? false : true"></textarea>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-6">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-sm-7 col-xs-11">
										<v-select class="notranslate" v-bind:options="products" v-model="selectedProduct" label="display_text" v-on:input="onChangeProduct"></v-select>
									</div>
									<div class="col-sm-1 col-xs-1" style="padding: 0;">
								...
								<div class="form-group" style="display:none;">
									...
									<div class="col-sm-8">
										<input type="text" id="group" name="group" class="form-control notranslate" placeholder="Group name" readonly />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" id="purchaseRate" name="purchaseRate" class="form-control notranslate" placeholder="Pur. Rate" v-model="selectedProduct.Product_Purchase_Rate" v-on:input="productTotal" required />
									</div>

									<label class="col-sm-2 control-label no-padding-right"> Quantity </label>
									<div class="col-sm-3">
										<input type="text" step="0.01" id="quantity" name="quantity" class="form-control notranslate" placeholder="Quantity" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" required />
									</div>
								</div>
								...
								<div class="form-group" style="display:none;">
									...
									<div class="col-sm-3">
										<input type="text" id="cost" name="cost" class="form-control notranslate" placeholder="Cost" readonly />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="productTotal" name="productTotal" class="form-control notranslate" readonly v-model="selectedProduct.total" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" id="sellingPrice" name="sellingPrice" class="form-control notranslate" v-model="selectedProduct.Product_SellingPrice" />
									</div>
								</div>
				...
				<table class="table table-bordered" style="color:#000;margin-bottom: 5px;">
					<thead>
						<tr>
							...
							<th style="width:20%;color:#000;">Warehouse</th>
				...
				<div class="widget-main">
					<div class="row">
						<div class="col-sm-12 col-xs-12">
							<div class="table-responsive purchage-table">
								<table style="color:#000;margin-bottom: 0px;">
										...
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="subTotal" name="subTotal" class="form-control notranslate" v-model="purchase.subTotal" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="vatPercent" name="vatPercent" v-model="vatPercent" v-on:input="calculateTotal" style=";" />
													<span style="width:20px;"> % </span>
													<input type="number" id="vat" name="vat" class="vat-field" v-model="purchase.vat" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-5 control-label no-padding-right">Discount</label>
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="discount" name="discount" class="form-control notranslate" v-model="purchase.discount" v-on:input="calculateTotal" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="freight" name="freight" class="form-control notranslate" v-model="purchase.freight" v-on:input="calculateTotal" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="labour" name="labour" class="form-control notranslate" v-model="purchase.labour" v-on:input="calculateTotal" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="total" class="form-control notranslate" v-model="purchase.total" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12 col-xs-7">
													<input type="number" id="paid" class="form-control notranslate" v-model="purchase.paid" v-on:input="calculateTotal" v-bind:disabled="selectedSupplier.Supplier_Type == 'G' ? true : false" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<label class="col-sm-12 col-xs-2 control-label no-padding-right">Due</label>
												<div class="col-sm-6 col-xs-5">
													<input type="number" id="due" name="due" class="form-control notranslate" v-model="purchase.due" readonly />
												</div>
												<div class="col-sm-6 col-xs-5">
													<input type="number" id="previousDue" name="previousDue" class="form-control notranslate" v-model="purchase.previousDue" readonly style="color:red;" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												<div class="col-sm-6">
													<input type="button" class="btn btn-success custom-btn" value="Purchase" v-on:click="savePurchase" v-bind:disabled="purchaseOnProgress == true ? true : false" style="background:#000;color:#fff;padding:3px;width:100%;">
												</div>
												<div class="col-sm-6">
													<input type="button" class="btn btn-info custom-btn" onclick="window.location = '<?php echo base_url(); ?>purchase'" value="New Purch.." style="background:#000;color:#fff;padding:3px;width:100%;">
												</div>
											</div>
										</td>
									</tr>
	...
	new Vue({
		...
		data() {
			return {
				...
				vatPercent: 0.00,
				selectedLoginBranch: "<?php echo $this->session->userdata('BRANCHid'); ?>",
				branches: [],
				selectedBranch: {
					Brunch_name: 'Select a Warehouse',
					brunch_id: '0'
				},
				suppliers: [],
				selectedSupplier: {
		...
		methods: {
			...
			addToCart() {
				if (this.selectedBranch == null || this.selectedBranch.brunch_id == '0') {
					alert('Please Select Brunch');
					return;
				}
				let cartInd = this.cart.findIndex(p => p.productId == this.selectedProduct.Product_SlNo && p.branchId == this.selectedProduct.brunch_id);
				if (cartInd > -1) {
			...
			calculateTotal() {
				...
				this.purchase.total = (parseFloat(this.purchase.subTotal) + parseFloat(this.purchase.vat) + parseFloat(this.purchase.freight) + parseFloat(this.purchase.labour)) - this.purchase.discount;
			...
			savePurchase() {
				...
				this.purchase.purchaseFor = this.selectedLoginBranch;
			...
			getPurchase() {
				axios.post('/get_purchases', {
					...
					this.purchase.labour = purchase.PurchaseMaster_LabourCost;
