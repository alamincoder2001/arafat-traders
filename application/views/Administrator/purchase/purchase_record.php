		...
		<div class="col-md-12">
			<form class="form-inline" id="searchForm" @submit.prevent="getSearchResult">
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: searchType == 'supplier' && suppliers.length > 0 ? '' : 'none'}">
					...
					<v-select class="notranslate" v-bind:options="suppliers" v-model="selectedSupplier" label="display_name"></v-select>
				</div>
				...
				<div class="form-group" v-bind:style="{display: searchTypesForRecord.includes(searchType) ? '' : 'none'}">
					...
					<select class="form-control notranslate" v-model="recordType" @change="purchases = []">
