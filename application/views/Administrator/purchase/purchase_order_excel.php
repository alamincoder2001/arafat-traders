...
<div class="row">
		<div class="form-group">
			...
			<div class="col-sm-2">
				<input type="text" id="purchInvoice" name="purchInvoice" value="<?php echo $purchInvoice; ?>" class="form-control notranslate" readonly />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-3">
				<input class="form-control notranslate date-picker" id="Purchase_date" name="Purchase_date" type="text" class="form-control notranslate" value="<?php echo date('Y-m-d'); ?>" name="pdate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;padding: 4px 6px 4px !important;width: 230px;float:left;" />
			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="supName" name="supName" placeholder="Supplier Name" class="form-control notranslate" readonly />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="mobile_no" name="mobile_no" placeholder="Mobile No" class="form-control notranslate" readonly />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea id="supaddress" name="supaddress" placeholder="Address" class="form-control notranslate" readonly ></textarea>
						</div>
					</div>
					</span>
				</div>
				...
				<div class="col-sm-6">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="file" id="excel_file" name="excel_file" class="form-control notranslate" accept=".xls, .xlsx" style="height:35px;" />
						</div>
					</div>
					...
					<!---<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" id="productName" name="productName" placeholder="Product Name" class="form-control notranslate" readonly />
						</div>
					</div>
					...
					<div class="col-sm-3">
						<input type="text" id="ProductRATE" name="ProductRATE" value="" class="form-control notranslate" placeholder="Body Rate" readonly />
					</div>
					
					<label class="col-sm-2 control-label no-padding-right" for="PurchaseQTY"> Quantity </label>
					<div class="col-sm-3">
						<input type="text" id="PurchaseQTY" name="PurchaseQTY" value="" class="form-control notranslate" placeholder="Quantity" readonly />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="cost" name="cost" value="" class="form-control notranslate" placeholder="Cost"readonly />
					</div>
					
					<label class="col-sm-2 control-label no-padding-right" for="PurchaseRate"> P. Rate </label>
					<div class="col-sm-3">
						<input type="text" id="PurchaseRate" name="PurchaseRate" value="" class="form-control notranslate" placeholder="Pur. Rate" readonly />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input type="text" id="totalAmount" name="totalAmount" value="0" class="form-control notranslate" readonly />
					</div>
				</div>-->
				</span>
						...
						<table class="" cellspacing="0" cellpadding="0" style="color:#000;margin-bottom: 0px;">
							...
							<tr>
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="number" id="subTotalDisabled" name="subTotalDisabled" value="0" class="form-control notranslate" readonly />
							...
							<tr>
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="number" id="purchFreight" onkeyup="Freightonkeyup()" name="purchFreight" value="0" class="form-control notranslate" />
									</div>
								 </div>
								</td>
							</tr>
							...
							<tr>
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="number" id="purchDiscount" onkeyup="Discountonkeyup()" name="purchDiscount" value="0" class="form-control notranslate" />
									</div>
								 </div>
								</td>
							</tr>
							...
							<tr>
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="number" id="purchTotaldisabled" value="0" class="form-control notranslate" readonly />
							...
							<tr>
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="number" id="PurchPaid" value="0" onkeyup="PaidAmount()" class="form-control notranslate" />
									</div>
								 </div>
								</td>
							</tr>
							...
							<tr>
								...
								<div class="form-group">
									...
									<div class="col-sm-12">
										<input type="number" id="purchaseDue2" name="purchaseDue2" value="0" class="form-control notranslate" readonly />
