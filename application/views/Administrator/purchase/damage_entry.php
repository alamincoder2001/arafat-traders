        ...
        <div class="col-md-12">
            <form class="form-horizontal" @submit.prevent="addDamage">
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" placeholder="Code" class="form-control notranslate" v-model="damage.Damage_InvoiceNo" required readonly/>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
                        <input type="date" placeholder="Date" class="form-control notranslate" v-model="damage.Damage_Date" required/>
                    </div>
				</div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
						<v-select class="notranslate" v-bind:options="products" label="display_text" v-model="selectedProduct" placeholder="Select Product"></v-select>
                    </div>
				</div>
				...
				<div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
                        <input type="number" placeholder="Quantity" class="form-control notranslate" v-model="damage.DamageDetails_DamageQuantity" required/>
                    </div>
				</div>
				...
				<div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
                        <input type="number" placeholder="Amount" class="form-control notranslate" v-model="damage.damage_amount" required/>
                    </div>
				</div>
                ...
                <div class="form-group">
                    ...
                    <label class="col-sm-1 control-label no-padding-right">:</label>
                    <div class="col-sm-3">
                        <textarea class="form-control notranslate" placeholder="Description" v-model="damage.Damage_Description" required></textarea>
                    </div>
                </div>
