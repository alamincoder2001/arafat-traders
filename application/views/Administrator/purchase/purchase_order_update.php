        ...
        <div class="row">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-3">
                    <!--name="pdate"-->
                    <input
                            class="form-control notranslate date-picker"
                            id="Purchase_date"
                            name="Purchase_date"
                            type="text"
                            readonly
            ...
            <div class="widget-body">
                <div class="widget-main">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" id="group" name="group" class="form-control notranslate" placeholder="Group name"
                                           readonly/>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-3">
                            <input type="text" id="PurchaseRate" name="PurchaseRate" value="" class="form-control notranslate"
                                   placeholder="Pur. Rate" readonly/>
                        </div>

                        <label class="col-sm-2 control-label no-padding-right" for="PurchaseQTY"> Quantity </label>
                        <div class="col-sm-3">
                            <input type="text" id="PurchaseQTY" name="PurchaseQTY" value="" class="form-control notranslate"
				 ...
				 <div class="form-group" style="display:none;">
					...
					<div class="col-sm-3">
						<input type="text" id="cost" name="cost" value="" class="form-control notranslate" placeholder="Cost"
                               readonly/>
					</div>
				</div>
