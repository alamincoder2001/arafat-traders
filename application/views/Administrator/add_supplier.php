		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="supplier.Supplier_Code" required readonly>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="supplier.Supplier_Name" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="supplier.contact_person">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="supplier.Supplier_Address">
					</div>
				</div>
			</div>	
			...
			<div class="col-md-5">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="supplier.Supplier_Mobile" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="supplier.Supplier_Email">
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="number" class="form-control notranslate" v-model="supplier.previous_due" required>
					</div>
				</div>
