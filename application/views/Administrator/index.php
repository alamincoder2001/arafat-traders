	...
	<body class="skin-2">
			...
			<div class="navbar-container ace-save-state" id="navbar-container">
				...
				<div class="navbar-buttons navbar-header pull-right" role="navigation">
					...
					<?php endif; ?>
						...
						<li class="time-hide-m">
							<a class="clock" >
								<span><i class="ace-icon fa fa-clock-o"></i></span> <span class="timezone"><?php  date_default_timezone_set('Asia/Dhaka'); echo date("l, d F Y"); ?>,&nbsp;<span id="timer"></span></span>
							</a>
						</li>
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div id="sidebar" class="sidebar responsive ace-save-state sidebar-fixed sidebar-scroll">
				...
				<div class="sidebar-shortcuts" id="sidebar-shortcuts" style="margin-top: 40px;">
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs" style="margin-top: 48px;">
						<ul class="breadcrumb">
							<li>
			...
			jQuery(function($){
				...
				$('.multiselect').multiselect({
				 ...
				 templates: {
					...
					filter: '<li class="multiselect-item filter"><div class="input-group"><span class="input-group-addon"><i class="fa fa-search"></i></span><input class="form-control notranslate multiselect-search" type="text"></div></li>',
