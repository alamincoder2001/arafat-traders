							...
							<div class="col-sm-12">
								...
								<div class="form-group">
									<div class="col-sm-3 no-padding-right">
										<input class="form-control notranslate date-picker" id="paid_start_date" type="text" value="<?= date('Y-m-d')?>" placeholder="Start Date"  data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important; padding: 4px 6px 4px !important; width: 175px;float:left; " />
								...
								<div class="form-group">
									<div class="col-sm-3 no-padding-right">
										<input class="form-control notranslate date-picker" id="paid_end_date" type="text" value="<?= date('Y-m-d')?>" placeholder="End Date" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;padding: 4px 6px 4px !important;width: 175px;float:left;" />
										<span class="input-group-addon" style="border-radius: 0px 4px 4px 0px !important;padding: 4px 6px 4px  !important;">
											<i class="fa fa-calendar bigger-110"></i>
										</span>
									</div>
					...
					<div class="widget-main">
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="form-group">
									<div class="col-sm-3 no-padding-right">
										<input class="form-control notranslate date-picker" id="sale_start_date" name="sales_date" type="text" value="<?php echo date('Y-m-d'); ?>" name="pdate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important; padding: 4px 6px 4px !important; width: 175px;float:left; " />
										<span class="input-group-addon" style="border-radius: 0px 4px 4px 0px !important;padding: 4px 6px 4px  !important;">
											<i class="fa fa-calendar bigger-110"></i>
										</span>
									</div>
								...
								<div class="form-group">
									<div class="col-sm-3 no-padding-right">
										<input class="form-control notranslate date-picker" id="sale_end_date" name="sales_date" type="text" value="<?php echo date('Y-m-d'); ?>" name="pdate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;padding: 4px 6px 4px !important;width: 175px;float:left;" />
										<span class="input-group-addon" style="border-radius: 0px 4px 4px 0px !important;padding: 4px 6px 4px  !important;">
											<i class="fa fa-calendar bigger-110"></i>
										</span>
									</div>
