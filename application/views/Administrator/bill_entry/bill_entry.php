            ...
            <div class="form-horizontal">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="date" id="date" class="form-control notranslate date-picker"
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-sm-1 control-label">:</label>
                        <div class="col-sm-6">
                            <textarea placeholder="Enter Remarks" name="remarks" class="form-control notranslate"></textarea>
                        </div>
                    </div>
...
<div class="row" style="padding-top: 15px; margin-top: 15px; border-top: 2px solid #2ca980;">
    ...
    <div class="col-xs-2">
        <div class="input-group">
            <input class="form-control notranslate date-picker" id="sDate" type="text" data-date-format="yyyy-mm-dd"
    ...
    <div class="col-xs-2">
        <div class="input-group">
            <input class="form-control notranslate date-picker" id="eDate" type="text" data-date-format="yyyy-mm-dd"
                   style="border-radius: 5px 0px 0px 5px !important;" value="<?php echo date("Y-m-d") ?>"/>
            <span class="input-group-addon"
                  style="border-radius: 0px 4px 4px 0px !important;padding: 4px 6px 4px  !important;">
				<i class="fa fa-calendar bigger-110"></i>
