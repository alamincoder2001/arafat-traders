	...
	<div class="form-horizontal">
		...
		<form method="post" id="Form">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<input type="text" name="date" id="date" class="form-control notranslate date-picker" value="<?=$edit->date; ?>"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
					<input type="text" id="amount" required name="amount"  placeholder="Enter Amount" value="<?=$edit->amount?>" class="form-control notranslate" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
					<textarea placeholder="Enter Remarks" name="remarks" class="form-control notranslate"><?=$edit->remarks?></textarea>
				</div>
			</div>
