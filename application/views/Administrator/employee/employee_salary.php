			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-7">
						...
						<v-select class="notranslate" v-bind:options="employees" label="display_name" v-model="selectedEmployee" @input="getPayableSalary" style="display:none;" v-bind:style="{display: employees.length > 0 ? '' : 'none'}"></v-select>
					</div>
				...
				<div class="form-group" v-if="selectedEmployee != null" style="display:none;" v-bind:style="{display: selectedEmployee == null ? 'none' : ''}">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="selectedEmployee.salary_range" disabled>
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">Month</label>
					<div class="col-md-7">
						<select class="form-control notranslate" v-bind:style="{display: months.length > 0 ? 'none' : ''}"></select>
						<v-select class="notranslate" v-bind:options="months" label="month_name" v-model="selectedMonth" @input="getPayableSalary" style="display:none;" v-bind:style="{display: months.length > 0 ? '' : 'none'}"></v-select>
					</div>
				...
				<div class="form-group" style="display:none;" v-bind:style="{display: payment.employee_payment_id == null ? '' : 'none'}">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="payable_amount" disabled>
					</div>
				</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="payment.payment_date">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">Payment Amount</label>
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="payment.payment_amount">
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-md-4">Deduction Amount</label>
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="payment.deduction_amount">
					</div>
				</div>
				<div class="form-group">
