...
<div class="row">
	...
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="Employeer_id" id="Employeer_id" name="Employeer_id" value="<?php echo $generateCode; ?>" class="form-control notranslate" readonly />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_name" name="em_name" value="<?php echo set_value('em_name'); ?>" placeholder="Employee Name .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
				<input class="form-control notranslate date-picker" name="em_Joint_date" id="em_Joint_date" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" value="<?php echo date("Y-m-d") ?>" />
				</div>
			</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="salary_range" name="salary_range" value="<?php echo set_value('phone_number'); ?>" placeholder="Salary Range .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_Present_address" name="em_Present_address" placeholder="Present Address" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_Permanent_address" name="em_Permanent_address" placeholder="Present Address" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="em_contact" name="em_contact"  placeholder="Contact No" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="ec_email" name="ec_email" placeholder="E-mail" class="form-control notranslate" />
			</div>
		</div>
	...
	<div class="form-horizontal">
		...
		<hr/>
			<div class="form-group">
				...
				<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
					<input type="text" id="em_father" name="em_father" placeholder="Father's Name" class="form-control notranslate" />
				</div>
			</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="mother_name" name="mother_name" placeholder="Mother's Name" class="form-control notranslate" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
				<div class="col-sm-6">
				<input class="form-control notranslate date-picker" name="em_dob" id="em_dob" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" value="<?php echo date("Y-m-d") ?>" />
				</div>
			</div>
