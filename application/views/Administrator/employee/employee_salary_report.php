		...
		<div class="col-md-12">
			<form class="form-inline" @submit.prevent="showReport">
				<div class="form-group">
					...
					<select class="form-control notranslate" v-model="reportType" @change="onChangeReportType">
				...
				<div class="form-group" v-if="reportType == 'records'">
					...
					<select class="form-control notranslate" style="min-width:200px;" v-bind:style="{display: comEmployees.length > 0 ? 'none' : ''}"></select>
					<v-select class="notranslate" v-bind:options="comEmployees" v-model="selectedEmployee" label="display_text" 
							style="display:none"
				...
				<div class="form-group">
					<label>Month</label>
					<select class="form-control notranslate" style="min-width:150px;" v-bind:style="{display: months.length > 0 ? 'none' : ''}"></select>
					<v-select class="notranslate" v-bind:options="months" v-model="selectedMonth" label="month_name"
							style="display:none"
