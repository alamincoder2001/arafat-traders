...
<form class="form-horizontal" method="post" id="saleryform" action="">
	<div class="col-sm-6">
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" name="salary_range" id="salary_range"value="<?php echo $selected->salary_range; ?>" class="form-control notranslate" readonly />
	...
	<div class="col-sm-6">
		...
		<label class="col-sm-1 control-label">:</label>	
			<div class="col-sm-6">
			<input class="form-control notranslate date-picker" name="date" id="date" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px !important;" value="<?php echo $selected->payment_date; ?>" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="payment" name="payment" value="<?php echo $selected->payment_amount; ?>" placeholder="Purchase Rate" class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="deduction" name="deduction" value="<?php echo $selected->deduction_amount; ?>"  placeholder="Purchase Rate" class="form-control notranslate" />
				 <div id="Purchase_rate_" class="col-sm-12"></div>
			</div>
		</div>
