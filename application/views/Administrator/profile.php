								...
								<form action="<?= base_url()?>password_change" method="POST">
									<div class="profile-user-info">
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<input type="password" name="current_password" class="form-control notranslate" placeholder="Current Password" style="width: 30%;">
											</div>
										</div>
										...
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<input type="password" name="password" class="form-control notranslate" placeholder="New Password" style="width: 30%;">
											</div>
										</div>
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<input type="password" name="confirm_password" class="form-control notranslate" placeholder="Confirm Password" style="width: 30%;">
											</div>
										</div>
										<div class="profile-info-row">
