			...
			<section class="" id="printButton" style="background:#f4f4f4;height:200px;">
			 <div class="">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2"> 
					<input type="text" name="pID" class="form-control notranslate mytext" placeholder="Product ID ..." value="<?php echo $row_product['Product_Code']; ?>" />
				</div>
				
				<label class="control-label col-sm-2" for="text">Product Name</label>
				<div class="col-sm-2"> 
					<input type="text" name="pname" class="form-control notranslate mytext" placeholder="Product name ..." value="<?php echo $row_product['Product_Name']; ?>" /> 
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" name="Price" class="form-control notranslate mytext" placeholder="Product price ..." value="<?php echo $row_product['Product_SellingPrice']; ?>" />
				</div>
				
				<label class="control-label col-sm-2" for="Price">Article </label>
				<div class="col-sm-2">
					<input type="text" name="article" class="form-control notranslate mytext" placeholder="Article ..." />
				</div>
				<div class="col-sm-2">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2"> 
				  <input type="text" name="qty" class="form-control notranslate mytext" placeholder="Product quantity ...">
				</div>
				
				<label class="control-label col-sm-2" for="date">Date</label>
				<div class="col-sm-2"> 
					<input type="date" name="date" class="form-control notranslate mytext" />
				</div>
			  </div>
		</section>
		</form>
