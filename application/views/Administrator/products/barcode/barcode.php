			...
			<section class="" id="printButton" style="background:#f4f4f4;height:200px;">
			 <div class="">
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2"> 
					<input type="text" name="pID" class="form-control notranslate mytext" placeholder="Product ID ..." value="<?php echo $product->Product_Code; ?>" />
				</div>
				
				<label class="control-label col-sm-2" for="text">Product Name</label>
				<div class="col-sm-2"> 
					<input type="text" name="pname" class="form-control notranslate mytext" placeholder="Product name ..." value="<?php echo $product->Product_Name; ?>" /> 
				</div>
			  </div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" name="Price" class="form-control notranslate mytext" placeholder="Product price ..." value="<?php echo $product->Product_SellingPrice; ?>" />
				</div>
