		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="product.Product_Code" readonly>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control notranslate" v-if="categories.length == 0"></select>
						<v-select class="notranslate" v-bind:options="categories" v-model="selectedCategory" label="ProductCategory_Name" v-if="categories.length > 0"></v-select>
					</div>
				...
				<div class="form-group clearfix" style="display:none;">
					...
					<div class="col-md-7">
						<select class="form-control notranslate" v-if="brands.length == 0"></select>
						<v-select class="notranslate" v-bind:options="brands" v-model="selectedBrand" label="brand_name" v-if="brands.length > 0"></v-select>
					</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="product.Product_Name" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<select class="form-control notranslate" v-if="units.length == 0"></select>
						<v-select class="notranslate" v-bind:options="units" v-model="selectedUnit" label="Unit_Name" v-if="units.length > 0"></v-select>
					</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="product.vat">
					</div>
				</div>
			</div>	
			...
			<div class="col-md-6">
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="product.Product_ReOrederLevel" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="product.Product_Purchase_Rate" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="product.Product_SellingPrice" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control notranslate" v-model="product.Product_WholesaleRate" required>
					</div>
				</div>
				<div class="form-group clearfix">
		...
		<div class="row">
			<div class="col-sm-12 form-inline">
				<div class="form-group">
					...
					<input type="text" class="form-control notranslate" v-model="filter" placeholder="Filter">
				</div>
			</div>
			<div class="col-md-12">
