	...
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control notranslate" v-model="quotation.invoiceNo" readonly />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					<input type="text" class="form-control notranslate" v-model="quotation.quotationBy" readonly />
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-3">
					<input class="form-control notranslate" type="date" v-model="quotation.quotationDate"/>
				</div>
			</div>
		</div>
	</div>
					...
					<div class="row">
						<div class="col-sm-5">
							<div class="form-group clearfix">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control notranslate" v-model="quotation.customerName" placeholder="Customer/Company Name">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" placeholder="Mobile No" class="form-control notranslate" v-model="quotation.customerMobile" />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<textarea placeholder="Address" class="form-control notranslate" v-model="quotation.customerAddress"></textarea>
								</div>
							</div>
						</div>
						...
						<div class="col-sm-5">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group" style="display: none;">
									...
									<div class="col-sm-9">
										<input type="text" placeholder="Group" class="form-control notranslate" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" placeholder="Rate" class="form-control notranslate" v-model="selectedProduct.Product_SellingPrice" v-on:input="productTotal"/>
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> Quantity </label>
									<div class="col-sm-9">
										<input type="number" id="quantity" placeholder="Qty" class="form-control notranslate" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" autocomplete="off" required/>
									</div>
								</div>
								...
								<div class="form-group" style="display:none;">
									...
									<div class="col-sm-9">
										<span>(%)</span>
										<input type="text" placeholder="Discount" class="form-control notranslate" style="display: inline-block; width: 90%" />
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"> Amount </label>
									<div class="col-sm-9">
										<input type="text" placeholder="Amount" class="form-control notranslate" v-model="selectedProduct.total" readonly />
									</div>
								</div>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="number" class="form-control notranslate" v-model="quotation.subTotal" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="number" class="form-control notranslate" v-model="vatPercent" v-on:input="calculateTotal"/>
												</div>
												<label class="col-sm-1 control-label no-padding-right">%</label>
												<div class="col-sm-7">
													<input type="number" readonly class="form-control notranslate" v-model="quotation.vat"/>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr style="display:none;">
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="number" class="form-control notranslate" />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="number" class="form-control notranslate" v-model="discountPercent" v-on:input="calculateTotal"/>
												</div>

												<label class="col-sm-1 control-label no-padding-right">%</label>

												<div class="col-sm-7">
													<input type="number" id="discount" class="form-control notranslate" v-model="quotation.discount" v-on:input="calculateTotal"/>
												</div>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<div class="col-sm-12">
													<input type="number" class="form-control notranslate" v-model="quotation.total" readonly />
												</div>
											</div>
										</td>
									</tr>
