              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" id="bank_name"  name="bank_name" required placeholder="Bank Name" class="form-control notranslate"  />
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" id="branch_name"  name="branch_name" required placeholder="Branch Name" class="form-control notranslate"  />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" id="check_no"  name="check_no" required placeholder="Cheque No" class="form-control notranslate"  />
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" id="check_amount"  name="check_amount" required placeholder="Cheque Amount" class="form-control notranslate"  />
                    </div>
                  </div>
                  <div class="form-group">
                ...
                <div class="col-sm-4">
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                       <input class="form-control notranslate date-picker" required id="date" name="date" type="text" value="<?php echo date('Y-m-d'); ?>"  data-date-format="yyyy-mm-dd" />
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                       <input class="form-control notranslate date-picker" required id="check_date" name="check_date" type="text" value="<?php echo date('Y-m-d'); ?>"  data-date-format="yyyy-mm-dd" />
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                       <input class="form-control notranslate date-picker" required id="remid_date" name="remid_date" type="text" value="<?php echo date('Y-m-d'); ?>"  data-date-format="yyyy-mm-dd" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label no-padding-left" for="sub_date">Submit Date:<span class="text-bold text-danger">*</span> </label>
                    <div class="col-sm-7">
                       <input class="form-control notranslate date-picker" required id="sub_date" name="sub_date" type="text" value="<?php echo date('Y-m-d'); ?>"  data-date-format="yyyy-mm-dd" />
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-5 control-label no-padding-left" for="note">Despription: </label>
                    <div class="col-sm-7">
                       <input type="text" id="note" name="note" class="form-control notranslate"  placeholder="Despription" />
                    </div>
                  </div>
