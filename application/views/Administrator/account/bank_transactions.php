                    ...
                    <div class="col-md-6 col-md-offset-1">
                        <form action="" class="form-horizontal" @submit.prevent="saveTransaction">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="date" class="form-control notranslate" v-model="transaction.transaction_date" required @change="getTransactions">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <v-select class="notranslate" v-bind:options="filteredAccounts" v-model="selectedAccount" label="display_text" placeholder="Select account" @input="getBankBalance"></v-select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control notranslate" v-model="transaction.transaction_type" required style="padding:0px;">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control notranslate" v-model="transaction.amount" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control notranslate" v-model="transaction.note"></textarea>
                                </div>
                            </div>
