        ...
        <div class="col-md-12">
            <form class="form-inline" @submit.prevent="getTransactions">
                <div class="form-group">
                    <label>Account</label>
                    <v-select class="notranslate" v-bind:options="computedAccounts" v-model="selectedAccount" label="display_text" @input="resetData"></v-select>
                </div>

                <div class="form-group">
                    <label>Date From</label>
                    <input type="date" class="form-control notranslate" v-model="filter.dateFrom" @change="resetData">
                </div>

                <div class="form-group">
                    <label>to</label>
                    <input type="date" class="form-control notranslate" v-model="filter.dateTo" @change="resetData">
                </div>
                ...
                <table class="table table-bordered table-condensed" id="transactionsTable">
                    ...
                    <tbody>
                        ...
                        <tr style="font-weight:bold;">
                            ...
                            <td style="text-align:right;">{{ transactions.reduce((p, c) => { return +p + +c.deposit }, 0) }}</td>
                            <td style="text-align:right;">{{ transactions.reduce((p, c) => { return +p + +c.withdraw }, 0) }}</td>
