                    ...
                    <div class="row">
                        <div class="col-md-4 col-md-offset-3">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control notranslate" v-model="account.Acc_Code" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control notranslate" v-model="account.Acc_Name" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control notranslate" v-model="account.Acc_Tr_Type">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <textarea class="form-control notranslate" v-model="account.Acc_Description"></textarea>
                                </div>
                            </div>
