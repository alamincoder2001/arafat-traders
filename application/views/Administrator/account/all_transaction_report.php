        ...
        <div class="col-md-12">
            <form class="form-inline" id="searchForm" @submit.prevent="getTransactions">
                <div class="form-group">
                    ...
                    <select class="form-control notranslate" v-model="filter.transactionType">
                ...
                <div class="form-group" style="display:none;" v-bind:style="{display: accounts.length > 0 ? '' : 'none'}">
                    ...
                    <v-select class="notranslate" v-bind:options="accounts" v-model="selectedAccount" label="Acc_Name" @input="onChangeAccount"></v-select>
                </div>
