...
<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-top:15px;">
	...
	<div class="form-group" style="margin-top:10px;" id="showcustomer">
		...
		<div class="col-sm-3">
			 <select id="accountid" class="form-control notranslate" style="height: 30px;" name="accountid" data-placholder="Select an account" >
		...
		<div class="col-sm-2">
			<div class="input-group">
				<input class="form-control notranslate date-picker" id="startdate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;" value="<?php echo date("Y-m-d") ?>" />
		...
		<div class="col-sm-2">
			<div class="input-group">
				<input class="form-control notranslate date-picker" id="enddate" type="text" data-date-format="yyyy-mm-dd" style="border-radius: 5px 0px 0px 5px !important;" value="<?php echo date("Y-m-d") ?>" />
				<span class="input-group-addon"style="border-radius: 0px 4px 4px 0px !important;padding: 4px 6px 4px  !important;">
					<i class="fa fa-calendar bigger-110"></i>
				</span>
			</div>
...
<script type="text/javascript">
    ...
    function searchforRecord(){
        ...
        var urldata = "<?php echo base_url();?>withdrawSearch";
        $.ajax({
            type: "POST",
            url: urldata,
            data: inputData,
