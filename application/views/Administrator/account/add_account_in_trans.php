...
<div style="width: 500px; ">
	<div style="width: 80%; height: 200px; margin: auto;margin-top: 30px;">
		<div class="form-group">
			...
			<div class="col-sm-6">
				<input type="text" name="account_id2" id="account_id2"  value="<?php echo $generateCode; ?>" class="form-control notranslate" readonly />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="accountName" name="accountName" value="<?php echo set_value('accountName'); ?>" placeholder="Account name .." class="form-control notranslate" />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input name="accoun" type="text" id="accoun" value="Official" class="form-control notranslate" readonly />
		...
		<div class="form-group">
			...
			<label class="col-sm-1 control-label">:</label>
			<div class="col-sm-6">
				<input type="text" id="Description" name="Description" value="" class="form-control notranslate" />
