				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						<div class="form-group">
							...
							<div class="col-md-7">
								<input type="text" class="form-control notranslate" v-model="transaction.Tr_Id" readonly>
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<select class="form-control notranslate" required v-model="transaction.Tr_Type" @change="onChangeTransactionType">
									<option value=""></option>
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-6">
								<select class="form-control notranslate" v-if="accounts.length == 0"></select>
								<v-select class="notranslate" v-bind:options="accounts" v-model="selectedAccount" label="Acc_Name" v-if="accounts.length > 0"></v-select>
							</div>
					...
					<div class="col-md-5">
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="date" class="form-control notranslate" required v-model="transaction.Tr_date" @change="getTransactions" v-bind:disabled="userType == 'u' ? true : false">
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="text" class="form-control notranslate" v-model="transaction.Tr_Description">
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" class="form-control notranslate" required v-model="transaction.In_Amount" 
									style="display:none;" 
									v-if="transaction.Tr_Type == 'In Cash'"
									v-bind:style="{display: transaction.Tr_Type == 'In Cash' ? '' : 'none'}"
								>
								<input type="number" class="form-control notranslate" required v-model="transaction.Out_Amount" 
